...
<head>
    ...
    <title>Arquitetura - LabRes</title>
    ...
    <div class="regras">
        <h1>Arquitetura</h1>
            <div class="listaregras">
                <p> Cada laboratório é composto por máquinas de arquiteturas variadas em cada laboratório, sendo elas:
                    <ul>
                        <li>i3 - 9ª geração</li>
                        <li>i5 - 9ª geração</li>
                        <li>i7 vPro - 9ª geração</li>
                    </ul>
                </p>
            </div>    
</body>
